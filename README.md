...
Project | cacophony-web [![Status](https://github.com/TheCacophonyProject/cacophony-web/workflows/Node%20CI%20and%20Release/badge.svg)](https://github.com/TheCacophonyProject/cacophony-web/actions)
---|---
Platform | Linux
Requires | <none>
...
`cacophony-web` using Docker. To do this:
...
The API server also serves up the generated API documentation at its
root URL.
...
### Releases
Releases are created using github and saved [on Github](https://github.com/TheCacophonyProject/cacophony-web/releases).   Follow our [release instructions](https://docs.cacophony.org.nz/home/creating-releases) to create a new release.


# cacophony-browse

This is a web interface for querying with and interacting with Cacophony Project recordings using the project's API. It is based on the [Vue](https://vuejs.org) framework.
