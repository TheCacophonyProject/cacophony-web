...
//    processingState: "analyse",
  ...
  if (Cypress.env("running_in_a_dev_environment") == true) {
    ...
    beforeEach(() => {
      ...
      cy.testDeleteRecordingsInState(superuser, "thermalRaw", "tracking");
      cy.testDeleteRecordingsInState(superuser, "audio", "tracking");
      cy.testDeleteRecordingsInState(superuser, "thermalRaw", "toMp3");
      ...
      cy.apiRecordingAdd(
        ...
        cy.apiRecordingAdd(
          ...
          cy.apiRecordingAdd(
            ...
            cy.log("Check recordings ordered by recordingDateTime (3,5,4) for TRACKING");
            cy.processingApiCheck(
              "thermalRaw",
              "tracking",
              "rpRecording3",
            ...
            cy.log("Check recordings ordered by recordingDateTime (3,5,4) for ANALYSE");
            cy.processingApiCheck(
              "thermalRaw",
              "analyse",
              "rpRecording3",
    ...
    it("Process thermalRaw and audio recordings in separate queues", () => {
      ...
      recording10.processingState = "analyse";
      recording11.processingState = "analyse";
      recording12.processingState = "analyse";
      recording13.processingState = "analyse";
      cy.apiRecordingAdd(
        "rpCamera1",
        recording10,
        "oneframe.cptv",
    ...
    it("Test other metadata can be set by processing", () => {
      ...
      cy.apiRecordingAdd(
        ...
        expectedRecording17.processingState = RecordingProcessingState.AnalyseThermal;
