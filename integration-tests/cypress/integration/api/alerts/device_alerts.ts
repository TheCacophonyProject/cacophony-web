...
describe("Devices alerts", () => {
  ...
  it("Cannot create alert with invalid condition", () => {
    // NOTE: This would be a typescript error, so we need to cast as unknown first, to
    //  say that we promise it is a valid type to be passed to the apiAddAlert function
    const BAD_POSSUM_ALERT = [
