...
// -> device.lastThermalRecordingTime undefined
//
// User reregisters a device
// -> Unassigned device history entry created: re-register
// -> device.activeAt set to creation time
// -> device.lastThermalRecordingTime undefined
// -> device.lastThermalRecordingTime undefined
...
// -> deviceHistory for that device created with station, location, time
...
// -> deviceHistory: same
//
//user adds an earlier recording to a station (before first recording, same location, after station created):
// -> station: same
// -> deviceHistory: 1st entry backdated
//
//user adds an earlier recording to a station (before first recording, nearby location, after station created):
// -> station: same
...
//// Recordings and moved locations ////
//// Recordings and reassigned locations ////
