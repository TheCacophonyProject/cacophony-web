...
describe("Stations: updating", () => {
  ...
  it("Warning given for update station too close to another in same group", () => {
    ...
    let expectedStation2=TestCreateExpectedStation(TemplateExpectedStation,"stuStation", 14);
    ...
    expectedStationTooClose.name="stationTooClose14";
    ...
    cy.apiStationUpdate("stuAdmin","stuStation14",stationTooClose, undefined, undefined, undefined, HTTP_OK200, {warnings: [`New station is too close to ${getTestName(station1.name)}`]});

    cy.log("Check stations both exist")
    cy.apiGroupStationCheck("stuAdmin", "stuGroup2", "stuStation13", expectedStation1);
    cy.apiGroupStationCheck("stuAdmin", "stuGroup2", "stationTooClose14", expectedStationTooClose);
  });
