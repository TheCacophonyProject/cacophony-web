...
describe("Events - add event on behalf of device", () => {
  ...
  it("Group admin can add event on behalf of device", () => {  
      const expectedEvent1={id: null, createdAt: null, DeviceId: getCreds("camera1").id, dateTime: firstTime, Device: {devicename: getTestName("camera1")}, EventDetail: {type: EventTypes.POWERED_ON, details: {}}};

      // add and verify events
      cy.apiEventsDeviceAddOnBehalf("groupAdmin1", "camera1", {type: EventTypes.POWERED_ON, details: {}}, [firstTime]);
      cy.apiEventsCheck("groupAdmin1","camera1",{}, [expectedEvent1],EXCL_ID_CREATED); 
  });

  it("Group member can add event on behalf of device", () => {  
      cy.apiCreateUser("groupMember2");
      const expectedEvent2={id: null, createdAt: null, DeviceId: getCreds("camera2").id, dateTime: firstTime, Device: {devicename: getTestName("camera2")}, EventDetail: {type: EventTypes.POWERED_ON, details: {}}};
      ...
      cy.apiEventsCheck("groupMember2","camera2",{}, [expectedEvent2],EXCL_ID_CREATED);
  });
  ...
  it("Device admin can add event on behalf of device", () => {  
      ...
      const expectedEvent3={id: null, createdAt: null, DeviceId: getCreds("camera3").id, dateTime: firstTime, Device: {devicename: getTestName("camera3")}, EventDetail: {type: EventTypes.POWERED_ON, details: {}}};

      // add and verify events
      cy.apiEventsDeviceAddOnBehalf("deviceAdmin3", "camera3", {type: EventTypes.POWERED_ON, details: {}}, [firstTime]);
      cy.apiEventsCheck("deviceAdmin3","camera3",{}, [expectedEvent3],EXCL_ID_CREATED);
  });
  ...
  it("Device member can add event on behalf of device", () => {  
      ...
      const expectedEvent4={id: null, createdAt: null, DeviceId: getCreds("camera4").id, dateTime: firstTime, Device: {devicename: getTestName("camera4")}, EventDetail: {type: EventTypes.POWERED_ON, details: {}}};

      // add and verify events
      cy.apiEventsDeviceAddOnBehalf("deviceMember4", "camera4", {type: EventTypes.POWERED_ON, details: {}}, [firstTime]);
      cy.apiEventsCheck("deviceMember4","camera4",{}, [expectedEvent4], EXCL_ID_CREATED);
  });
  ...
  it("Can reuse eventDetails by either specifying a duplicate description or specifying the eventDetailsId", () => {
      ...
      cy.log("check we can resue same eventDetailsIds by specifying same description");
      ...
      const expectedEvent7a={id: null, createdAt: null, DeviceId: getCreds("camera").id,dateTime: time1, Device: {devicename: getTestName("camera")}, EventDetail: eventDetails1}; 
      const expectedEvent7b={id: null, createdAt: null, DeviceId: getCreds("camera").id,dateTime: time2, Device: {devicename: getTestName("camera")}, EventDetail: eventDetails2};
      const expectedEvent7c={id: null, createdAt: null, DeviceId: getCreds("camera").id,dateTime: time3, Device: {devicename: getTestName("camera")}, EventDetail: eventDetails1}; 
      const expectedEvent7d={id: null, createdAt: null, DeviceId: getCreds("camera").id,dateTime: time4, Device: {devicename: getTestName("camera")}, EventDetail: eventDetails2};
      const expectedEvent7e={id: null, createdAt: null, DeviceId: getCreds("camera").id,dateTime: time5, Device: {devicename: getTestName("camera")}, EventDetail: eventDetails1};
      const expectedEvent7f={id: null, createdAt: null, DeviceId: getCreds("camera").id,dateTime: time6, Device: {devicename: getTestName("camera")}, EventDetail: eventDetails2};
      cy.apiEventsCheck("groupAdmin","camera",{}, [expectedEvent7a, expectedEvent7b, expectedEvent7c, expectedEvent7d, expectedEvent7e, expectedEvent7f],EXCL_ID_CREATED);
  });
  ...
  it("Can add multiple occurrences of an event", () => {
    ...
    const expectedEvent8a={id: null, createdAt: null, DeviceId: getCreds("camera8").id, dateTime: time11, Device: {devicename: getTestName("camera8")}, EventDetail: eventDetail};
    const expectedEvent8b={id: null, createdAt: null, DeviceId: getCreds("camera8").id, dateTime: time12, Device: {devicename: getTestName("camera8")}, EventDetail: eventDetail};
    const expectedEvent8c={id: null, createdAt: null, DeviceId: getCreds("camera8").id, dateTime: time13, Device: {devicename: getTestName("camera8")}, EventDetail: eventDetail};
    const expectedEvent8d={id: null, createdAt: null, DeviceId: getCreds("camera8").id, dateTime: time14, Device: {devicename: getTestName("camera8")}, EventDetail: eventDetail};

    cy.apiEventsCheck("groupAdmin8","camera8",{}, [expectedEvent8a, expectedEvent8b, expectedEvent8c, expectedEvent8d],EXCL_ID_CREATED);
  });
  ...
  it("Can upload event using devicename", () => {
    cy.apiEventsDeviceAddOnBehalf("groupAdmin9",getTestName("camera9"), eventDetails1, [time1]);

    const expectedEvent9={id: null, createdAt: null, DeviceId: getCreds("camera9").id, dateTime: time1, Device: {devicename: getTestName("camera9")}, EventDetail: eventDetails1};
  
    cy.apiEventsCheck("groupAdmin9","camera9",{}, [expectedEvent9], EXCL_ID_CREATED);
  ...
  it("Cannot upload event by devicename where duplicate devicenames exist", () => {
    ...
    cy.apiEventsDeviceAddOnBehalf("groupAdmin10",getTestName("camera"), eventDetails1, [timeNow],null,true,HTTP_Unprocessable);
  });
