...
import { HTTP_Forbidden, HTTP_Unprocessable, NOT_NULL } from "@commands/constants";
...
describe("Tracks: add, check, delete", () => {
  ...
  before(() => {
    ...
    cy.testCreateUserGroupAndDevice("trkGroup2Admin", "trkGroup2", "trkCamera2");
  });
  ...
  it("Group admin can add, view and delete device's tracks", () => {
    ...
    cy.apiTrackAdd("trkGroupAdmin","trkRecording1","trkTrack1","trkAlgorithm1",track1,algorithm1);

    cy.log("Check recording tag can be viewed correctly");
    cy.apiTrackCheck( "trkGroupAdmin", "trkRecording1", [expectedTrack], EXCLUDE_IDS);
  ...
  it("Group member can add, view and delete device's tracks", () => {
    ...
    cy.log("Add track to recording");
    cy.apiTrackAdd("trkGroupMember","trkRecording2","trkTrack2","trkAlgorithm2",track1,algorithm1);

    cy.log("Check recording tag can be viewed correctly");
    cy.apiTrackCheck( "trkGroupMember", "trkRecording2", [expectedTrack], EXCLUDE_IDS);
  ...
  it("Device admin can add, view and delete device's tracks", () => {
    ...
    cy.log("Add track to recording");
    cy.apiTrackAdd("trkDeviceAdmin","trkRecording3","trkTrack3","trkAlgorithm3",track1,algorithm1);

    cy.log("Check recording tag can be viewed correctly");
    cy.apiTrackCheck( "trkDeviceAdmin", "trkRecording3", [expectedTrack], EXCLUDE_IDS);
  ...
  it("Device member can add, view and delete device's tracks", () => {
    ...
    cy.log("Add track to recording");
    cy.apiTrackAdd("trkDeviceMember","trkRecording4","trkTrack4","trkAlgorithm4",track1,algorithm1);

    cy.log("Check recording tag can be viewed correctly");
    cy.apiTrackCheck( "trkDeviceMember", "trkRecording4", [expectedTrack], EXCLUDE_IDS);
    cy.log("Delete tag");
  ...
  it("Cannot add, view or delete tracks from someone else's device", () => {
    ...
    cy.apiTrackAdd("trkGroupAdmin","trkRecording5",null,null,track1,algorithm1,HTTP_Forbidden);

    cy.log("But device member can add track to recording");
    cy.apiTrackAdd("trkGroup2Admin","trkRecording5","trkTrack5","trkAlgorithm5",track1,algorithm1);
    ...
    cy.apiTrackDelete("trkGroupAdmin", "trkRecording5", "trkTrack5", HTTP_Forbidden);

    cy.log("Check track still exists");
    cy.apiTrackCheck( "trkGroup2Admin", "trkRecording5", [expectedTrack], EXCLUDE_IDS);
  });
  ...
  it("Can set all valid parameters", () => {
    ...
    cy.apiTrackAdd("trkGroup2Admin","trkRecording6","trkTrack6","trkAlgorithm6",minTrack,undefined);

    cy.log("Add track with all params");
    cy.apiTrackAdd("trkGroup2Admin","trkRecording6","trkTrack6b","trkAlgorithm6",track1,algorithm1);

    cy.log("Check both tracks added ok, ordered by start time");
    cy.apiTrackCheck( "trkGroup2Admin", "trkRecording6", [expectedTrack, expectedMinTrack], EXCLUDE_IDS);
  ...
  it.skip("Can handle invalid parameters", () => {
    ...
    cy.apiTrackAdd("trkGroup2Admin","trkRecording6","trkTrack6","trkAlgorithm6",{start_s: 2},undefined, HTTP_Unprocessable);
    cy.apiTrackAdd("trkGroup2Admin","trkRecording6","trkTrack6","trkAlgorithm6",{end_s: 2},undefined, HTTP_Unprocessable);

    cy.log("Add track with invalid fields");
    cy.apiTrackAdd("trkGroup2Admin","trkRecording6","trkTrack6","trkAlgorithm6",{badField: 2},undefined,HTTP_Unprocessable);

    cy.log("Add track with invalid field values");
    cy.apiTrackAdd("trkGroup2Admin","trkRecording6","trkTrack6","trkAlgorithm6",{start_s:1, end_s: 2, positions: "badValue" },undefined,HTTP_Unprocessable);

    cy.log("Add track with invalid algorithm field values"); 
    cy.apiTrackAdd("trkGroup2Admin","trkRecording6","trkTrack6","trkAlgorithm6",{start_s:1, end_s: 2 },"bad value",HTTP_Unprocessable);
  });  

  it("Can handle invalid recording", () => {
    cy.log("Correct rejection of non existant recording");
    cy.apiTrackAdd("trkGroupAdmin","99999","trkTrack8","trkAlgorithm8",track1,algorithm1,HTTP_Forbidden,{useRawRecordingId: true});
  });
  ...
  it("Can retrieve track and tag data uploaded by device", () => {
    ...
    cy.log("Check recording tag can be viewed correctly");
    cy.apiTrackCheck( "trkGroupAdmin", "trkRecording9", [expectedTrack], EXCLUDE_IDS);
