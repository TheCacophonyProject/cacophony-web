...
import "../commands/api/tracks.d.ts";
import "../commands/api/station.d.ts";
import "../commands/api/recording-tag.d.ts";
import "../commands/api/recording-tests.d.ts";
import "../commands/api/group.d.ts";
import "../commands/api/group-station.d.ts";
import "../commands/api/device.d.ts";
import "../commands/api/events.d.ts";
import "../commands/api/monitoring.d.ts";
import "../commands/api/recording.d.ts";

// Ensure this file is treated as a module while still allowing global augmentation.
export {};
...
declare global {
  ...
  namespace Cypress {
    ...
    type ApiTrackDataRequest =
      import("@typedefs/api/track").ApiTrackDataRequest;
    type ApiTrackResponse = import("@typedefs/api/track").ApiTrackResponse;
    type ApiTrackTagRequest =
      import("@typedefs/api/trackTag").ApiTrackTagRequest;
    ...
    type TestVisitSearchParams =
      import("@commands/types").TestVisitSearchParams;
    ...
    type ApiEventErrorCategory =
      import("@commands/types").ApiEventErrorCategory;
    type ApiPowerEventReturned =
      import("@commands//types").ApiPowerEventReturned;
    ...
    type ApiAuthenticateAccess =
      import("@commands//types").ApiAuthenticateAccess;
