...
declare namespace Cypress {
  interface Chainable {
     ...
     */
    apiEventsAdd(camera: string, description?: ApiEventDetail, dates?: string[], eventDetailId?: number, log?: boolean, statusCode?: number): any;
     ...
     */
    apiEventsCheck(user: string, device: string, queryParams: any, expectedEvents: ApiEventReturned[], excludeCheckOn?: string[], statusCode?: number, additionalChecks?: {}): any;
     ...
     * optionally exclude checks on values of specific keys (excludeCheckOn)
     */
    apiEventsErrorsCheck(user: string, device: string, queryParams: any, expectedErrors: ApiEventErrorCategory[], excludeCheckOn?: string[], statusCode?  : number, additionalChecks?:any): any;
     ...
     * Optionally: disable sorting with additionalChecks.doNotSort=true
     */
    apiPowerEventsCheck(user: string, device: string, queryParams: any, expectedEvent: ApiPowerEventReturned[], excludeCheckOn?: string[], statusCode?: number, additionalChecks?:any): any;
     ...
     *
     */
    apiPowerEventsCheckAgainstExpected( user: string, camera: string, expectedEvent: TestComparablePowerEvent, statusCode?: number): Chainable<Element>;
