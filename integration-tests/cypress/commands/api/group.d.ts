...
declare namespace Cypress {
  interface Chainable {
     ...
     */
    apiAddUserToGroup( groupAdminUser: string, userName: string, groupName: string, admin?: boolean, log?: boolean, statusCode?: number
    );
     ...
     * Optionally check for fail response (statusCode!=200)
     */
    apiRemoveUserFromGroup( groupAdminUser: string, userName: string, groupName: string, statusCode?: number);
  }
}
