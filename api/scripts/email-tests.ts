...
import {
    ...
    sendWelcomeEmailConfirmationEmail, sendAnimalAlertEmail
...
const sendTestEmails = async () => {
  ...
  await sendGroupInviteNewMemberEmail("FOO", "jon@hardiesoft.com", "My awesome group", "jon@cacophony.org.nz");
  await sendGroupInviteExistingMemberEmail("FOO", "jon@hardiesoft.com", "My awesome group", "jon@cacophony.org.nz");
  await sendGroupMembershipRequestEmail("FOO", "jon@cacophony.org.nz", "Your awesome group", "jon@hardiesoft.com");
