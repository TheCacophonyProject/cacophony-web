...
module.exports = {
    async up(queryInterface, Sequelize) {
        await queryInterface.addColumn("Visits", "aiClassificationRecordingId",{
        ...
        await queryInterface.addColumn("Visits", "humanClassificationRecordingId",{
            type: DataTypes.INTEGER,
            allowNull: true,
        });
        ...
        await queryInterface.removeColumn("Visits", "classification",)
    },
