  ...
  <div class="d-flex flex-row justify-content-between">
    <div>
      ...
      <b-list-group>
        ...
        <!--          name: 'set-location'-->
        <!--        }" button>-->
        <!--          <font-awesome-icon :icon="hasLocation ? ['far', 'circle-check'] : ['far', 'circle']" />-->
        <!--          Set a location</b-list-group-item>-->
        ...
        >
        <!--        <b-list-group-item :to="{ name: 'set-device-kind' }" button>-->
        <!--          <font-awesome-icon :icon="deviceTypeIsKnown ? ['far', 'circle-check'] : ['far', 'circle']" />-->
        <!--          Set device type (optional)</b-list-group-item>-->
      </b-list-group>
    </div>
    <div class="w-100">
      <div
