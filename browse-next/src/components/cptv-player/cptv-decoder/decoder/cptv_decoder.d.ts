...
import type {CptvFrame, CptvHeader} from "@/components/cptv-player/cptv-decoder/decoder.ts";
...
*/
  static newWithReadableStream(stream: ReadableStreamDefaultReader): CptvDecoderContext;
/**
...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1ea9dee0275cc798: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h9a4c6a115fd98b93: (a: number, b: number, c: number, d: number) => void;
}
