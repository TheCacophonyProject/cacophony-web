...
<template>
  ...
  >
    <div class="nav-top">
      ...
      <div
          class="group-switcher mt-5 mb-2"
      >
        <div class="d-flex flex-row justify-content-between align-items-center me-1">
          <label class="current-group-label text-body-secondary mx-3 text-nowrap">Your projects</label>
          <b-dropdown
              no-caret
              auto-close
              no-flip
          ...
          <b-tooltip target="create-project-btn" triggers="hover" placement="top" offset="20">
        ...
        <div class="d-flex flex-row justify-content-between">
          ...
          >
          <b-tooltip target="switch-project-btn" triggers="hover" placement="bottom">
            Switch project
          </b-tooltip>
        </div>
    ...
    <div class="d-flex align-items-center">
      ...
      >
        ...
        <span v-html="currentUserName" class="nav-text text-nowrap ms-3 text-truncate"></span>
      </router-link>
      <router-link
          :to="{ name: 'sign-out' }"
